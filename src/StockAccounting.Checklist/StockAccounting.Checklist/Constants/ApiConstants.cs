...
namespace StockAccounting.Checklist.Constants
{
    public static class ApiConstants
    {
        ...
        //public const string BaseApiUrl = "10.0.2.2";
        //public const string ApiUrl = "https://10.0.2.2:7088";
        public const string ApiUrl = "http://192.168.102.92:83";
        public const string DocumentData = "/api/documentdata";
        public const string DocumentDataInsert = "/api/documentdata/insertdocument";
